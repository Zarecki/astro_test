...
class Facility:
    def __init__(self, id = None, center, center_search_status, facility, occupied, status = None, url = None, record_date, last_update, country, contact, phone, latitude, longitude, human_address, city, state, zipcode, computed_region_bigw_e76g, computed_region_cbhk_fwbd, computed_region_nnqa_25f4):
        self.id = id
        self.center = center
